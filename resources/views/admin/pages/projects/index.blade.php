    ...
    <tbody>
      @foreach ($projects as $project)
        <tr>
            ...
            <td>
                <a href="{{route('admin.pages.projects.show' , $project->id)}}" class="btn btn-primary">Show</a>
                <a href="{{route('admin.pages.projects.edit' , $project->id)}}" class="btn btn-dark">Edit</a>
