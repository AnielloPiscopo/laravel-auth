...
<div class="card container">
  <div class="card-header">
    <div class="row">
      <div class="col-6">
        <h2 class="my_title fw-bold">List Of My Projects</h2>
      </div>

      <div class="col-6">
        <div class="text-end">
          @if ($numOfTrashedElements)
          <a href="{{route('admin.pages.projects.trashed')}}" class="my_btn btn btn-outline-danger" title="{{$numOfTrashedElements}} trashed elements">Go to the the recycled bin</a>
          @endif
